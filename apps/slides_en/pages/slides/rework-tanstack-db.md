...
<div class="flex flex-col w-full h-full gap-20">
  ...
  <div class="flex gap-12 justify-center items-stretch">
    ...
    <div v-click class="w-2/8 flex border border-4 border-red p-4 rounded-lg flex-col gap-4 items-center justify-center" style="background: radial-gradient(farthest-corner at 50% 30%, rgba(239, 68, 68, 0.45) 0%, rgba(254, 202, 202, 0.3) 55%, rgba(254, 242, 242, 0.18) 100%)">
      <div class="text-6xl">🔬</div>
      <div class="text-2xl text-center">Fine Grained Reactivity</div>
    </div>
    <div v-click class="w-2/8 flex border border-4 border-red p-4 rounded-lg flex-col gap-4 items-center justify-center" style="background: radial-gradient(farthest-corner at 50% 30%, rgba(239, 68, 68, 0.45) 0%, rgba(254, 202, 202, 0.3) 55%, rgba(254, 242, 242, 0.18) 100%)">
      <div class="text-6xl">🌈</div>
      <div class="text-2xl text-center">Optimistic update by design</div>
    </div>
  </div>
</div>
...
<div class="relative h-full min-h-96 w-full">
  ...
  >
    What is <TanstackTitle>TanStack <Orange>DB</Orange></TanstackTitle>?
  </h1>
  ...
  <div v-click="1" class="citation-reveal flex h-full flex-col items-center justify-center gap-4 px-8 pt-32">
    ...
    <p class="citation__author">— TanStack DB's team</p>
  </div>
</div>
...
<div class="h-110 flex flex-col justify-center items-center">
  <TanstackTitle class="text-6xl text-center">What if we redo the <br/><Orange>Iphonix</Orange> app?</TanstackTitle>
</div>
...
<h1 class="w-full text-left text-4xl"><TanstackTitle small><Orange>collections</Orange></TanstackTitle></h1>
<h2 class="w-full text-left text-xl opacity-75 italic">TanStack DB foundation</h2>
...
<div class="m-2 relative">
  <div v-click="[1, 2]" class="absolute inset-0">
    Easy refactor from TanStack Query ! 🎉
  </div>
  <div v-click="[2, 4]" class="absolute inset-0">
    Like a good old useQuery 🥳
...
```
  ...
  <div v-click="8" class="absolute inset-0">
    <h2 class="text-4xl w-full h-80 text-center flex items-center justify-center">Everything is ready! 🎉</h2>
  </div>
...
<h1 class="w-full text-left text-4xl"><TanstackTitle small><Orange>Live queries</Orange></TanstackTitle></h1>
...
<h1 class="w-full text-left text-4xl"><TanstackTitle small><Orange>Live queries</Orange></TanstackTitle></h1>
<h2 class="w-full text-left text-xl opacity-75 italic">a very complete api!</h2>
...
<h1 class="w-full text-left text-4xl"><TanstackTitle small><Orange>Mutations</Orange></TanstackTitle></h1>
<h2 class="w-full text-left text-xl opacity-75 italic">User actions</h2>
...
<ul class="w-full flex flex-col gap-6 text-3xl mt-20 mb-20">
  <li v-click>
    <span class="inline-block mr-4">🖥️</span> Can be use as a store
  </li>
  <li v-click>
    <span class="inline-block mr-4">⚡</span> Prototype without backend
  </li>
  <li v-click>
    <span class="inline-block mr-4">🧪</span> Great for testing 
  </li>
</ul>
---
layout: radial-gradient
...
<h1 class="w-full text-center text-4xl">
  <TanstackTitle small><Orange>TanStack</Orange> DB <Orange>benefits</Orange></TanstackTitle>
</h1>

<ul class="w-full flex flex-col gap-6 text-3xl mt-20 mb-20">
  <li v-click>
    <span class="inline-block mr-4">⏳</span> No loading time after the initial one
  </li>
  <li v-click>
    <span class="inline-block mr-4">🌈</span> Optimistic update by design
  </li>
  <li v-click>
    <span class="inline-block mr-4">🪓</span> Even more Separation of concerns
  </li>
  <li v-click>
    <span class="inline-block mr-4">🕹️</span> nearly perfect DX!
  </li>
  <li v-click>
    <span class="inline-block mr-4">🏎️</span> Perceived performance to the max
  </li>
</ul>
